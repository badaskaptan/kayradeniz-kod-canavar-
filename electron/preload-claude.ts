...
contextBridge.exposeInMainWorld('claudeAPI', {
  ...
  getApiKey: (): Promise<string | undefined> => ipcRenderer.invoke('claude:getApiKey'),
  ...
  clearApiKey: (): Promise<{ success: boolean }> => ipcRenderer.invoke('claude:clearApiKey'),

  hasApiKey: (): Promise<boolean> => ipcRenderer.invoke('claude:hasApiKey'),
  ...
  clearHistory: (): Promise<{ success: boolean }> => ipcRenderer.invoke('claude:clearHistory'),
